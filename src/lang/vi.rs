...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới SecureDesk..."),
        ...
        ("install_tip", "Do cơ chế UAC, SecureDesk có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt SecureDesk vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho SecureDesk."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho SecureDesk."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [SecureDesk Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep SecureDesk background service", "Giữ dịch vụ SecureDesk chạy nền"),
        ...
        ("Show SecureDesk", "Hiện SecureDesk"),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu SecureDesk"),
        ...
        ("scam_text2", "Chỉ sử dụng SecureDesk với những người bạn thực sự tin tưởng."),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ SecureDesk mở"),
        ...
        ("floating_window_tip", "Giữ SecureDesk trên cùng"),
        ...
        ("About SecureDesk", "Về SecureDesk"),
