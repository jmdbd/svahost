...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "状�?),
        ("Your Desktop", "你的桌面"),
        ("desk_tip", "你的桌面可以通过下面�?ID 和密码访问�?),
        ("Password", "密码"),
        ("Ready", "就绪"),
        ("Established", "已建�?),
        ("connecting_status", "正在接入 svahost 网络..."),
        ("Enable service", "允许服务"),
        ("Start service", "启动服务"),
        ("Service is running", "服务正在运行"),
        ("Service is not running", "服务未运�?),
        ("not_ready_status", "未就绪，请检查网络连�?),
        ...
        ("Enable clipboard", "允许同步剪贴�?),
        ("Enable file transfer", "允许传输文件"),
        ("Enable TCP tunneling", "允许建立 TCP 隧道"),
        ("IP Whitelisting", "IP 白名�?),
        ("ID/Relay Server", "ID/中继服务�?),
        ("Import server config", "导入服务器配�?),
        ("Export Server Config", "导出服务器配�?),
        ("Import server configuration successfully", "导入服务器配置信息成�?),
        ("Export server configuration successfully", "导出服务器配置信息成�?),
        ("Invalid server configuration", "服务器配置无效，请修改后重新复制配置信息到剪贴板，然后点击此按钮"),
        ("Clipboard is empty", "复制配置信息到剪贴板后点击此按钮，可以自动导入配�?),
        ("Stop service", "停止服务"),
        ("Change ID", "更改 ID"),
        ("Your new ID", "你的�?ID"),
        ("length %min% to %max%", "长度�?%min% �?%max% 之间"),
        ("starts with a letter", "以字母开�?),
        ("allowed characters", "使用允许的字�?),
        ("id_change_tip", "只可以使用字�?a-z, A-Z, 0-9, - (dash), _ (下划�?。首字母必须�?a-z, A-Z。长度在 6 �?16 之间�?),
        ("Website", "网站"),
        ("About", "关于"),
        ("Slogan_tip", "svahost Remote Desktop 用心制作 - 糖醋李余"),
        ...
        ("Relay Server", "中继服务�?),
        ("API Server", "API 服务�?),
        ("invalid_http", "必须�?http:// 或�?https:// 开�?),
        ("Invalid IP", "无效 IP"),
        ("Invalid format", "无效格式"),
        ("server_not_support", "服务器暂不支�?),
        ("Not available", "不可�?),
        ("Too frequent", "修改太频繁，请稍后再�?),
        ("Cancel", "取消"),
        ("Skip", "跳过"),
        ("Close", "关闭"),
        ("Retry", "再试"),
        ...
        ("Not an empty directory", "这不是一个空文件�?),
        ...
        ("Do this for all conflicts", "应用于其它冲�?),
        ...
        ("Disable clipboard", "禁用剪贴�?),
        ("Lock after session end", "会话结束后锁定远程电�?),
        ("Insert Ctrl + Alt + Del", "插入 Ctrl + Alt + Del"),
        ("Insert Lock", "锁定远程电脑"),
        ("Refresh", "刷新画面"),
        ("ID does not exist", "ID 不存�?),
        ("Failed to connect to rendezvous server", "连接注册服务器失�?),
        ("Please try later", "请稍后再�?),
        ("Remote desktop is offline", "远程电脑处于离线状�?),
        ("Key mismatch", "Key 不匹�?),
        ("Timeout", "连接超时"),
        ("Failed to connect to relay server", "无法连接到中继服务器"),
        ("Failed to connect via rendezvous server", "无法通过注册服务器建立连�?),
        ("Failed to connect via relay server", "无法通过中继服务器建立连�?),
        ("Failed to make direct connection to remote desktop", "无法直接连接到远程桌�?),
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由�?UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮�?svahost 安装到系统，从而规避上述问题�?),
        ("Click to upgrade", "点击这里升级"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给�?svahost \"辅助功能\" 权限�?),
        ("config_screen", "为了能够远程访问你的桌面, 请给�?svahost \"屏幕录制\" 权限�?),
        ("Installing ...", "安装�?.."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("setup_server_tip", "如果需要更快连接速度，你可以选择自建服务�?),
        ("Too short, at least 6 characters.", "太短了，至少 6 个字�?),
        ("The confirmation is not identical.", "两次输入不匹�?),
        ("Permissions", "权限"),
        ("Accept", "接受"),
        ("Dismiss", "拒绝"),
        ("Disconnect", "断开连接"),
        ...
        ("Direct and unencrypted connection", "非加密直�?),
        ("Relayed and unencrypted connection", "非加密中继连�?),
        ...
        ("Fix it", "修复"),
        ("Warning", "警告"),
        ("Login screen using Wayland is not supported", "不支持使�?Wayland 登录界面"),
        ("Reboot required", "重启后才能生�?),
        ...
        ("Username", "用户�?),
        ("Invalid port", "无效端口"),
        ("Closed manually by the peer", "被对方手动关�?),
        ("Enable remote configuration modification", "允许远程修改配置"),
        ("Run without install", "不安装直接运�?),
        ("Connect via relay", "中继连接"),
        ("Always connect via relay", "强制走中继连�?),
        ("whitelist_tip", "只有白名单里�?IP 才能访问本机"),
        ("Login", "登录"),
        ("Verify", "验证"),
        ("Remember me", "记住�?),
        ("Trust this device", "信任此设�?),
        ("Verification code", "验证�?),
        ("verification_tip", "已向注册邮箱发送了登录验证码，请输入验证码继续登录"),
        ("Logout", "登出"),
        ("Tags", "标签"),
        ("Search ID", "查找 ID"),
        ("whitelist_sep", "可以使用逗号，分号，空格或者换行符作为分隔�?),
        ("Add ID", "增加 ID"),
        ("Add Tag", "增加标签"),
        ("Unselect all tags", "取消选择所有标�?),
        ("Network error", "网络错误"),
        ("Username missed", "用户名没有填�?),
        ("Password missed", "密码没有填写"),
        ("Wrong credentials", "提供的登录信息错�?),
        ("The verification code is incorrect or has expired", "验证码错误或已超�?),
        ("Edit Tag", "修改标签"),
        ("Forget Password", "忘记密码"),
        ("Favorites", "收藏"),
        ("Add to Favorites", "加入到收�?),
        ("Remove from Favorites", "从收藏中删除"),
        ("Empty", "空空如也"),
        ("Invalid folder name", "无效文件夹名�?),
        ...
        ("android_input_permission_tip1", "为了让远程设备通过鼠标或触屏控制您的安卓设备，你需要允�?svahost 使用\"无障碍\"服务�?),
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进�?[已安装的服务] 页面，将 [svahost Input] 服务开启�?),
        ...
        ("android_start_service_tip", "点击开始服务或启用屏幕捕获权限，即可启动屏幕共享服�?),
        ("android_permission_may_not_change_tip", "对于已建立的连接，权限可能不会立即发生改变，除非重新建立连接�?),
        ("Account", "账户"),
        ("Overwrite", "覆盖"),
        ("This file exists, skip or overwrite this file?", "这个文件/文件夹已存在，跳�?覆盖�?),
        ("Quit", "退�?),
        ("Help", "帮助"),
        ("Failed", "失败"),
        ("Succeeded", "成功"),
        ("Someone turns on privacy mode, exit", "其他用户使用隐私模式，退�?),
        ("Unsupported", "不支�?),
        ("Peer denied", "被控端拒�?),
        ("Please install plugins", "请安装插�?),
        ("Peer exit", "被控端退�?),
        ("Failed to turn off", "退出失�?),
        ("Turned off", "退�?),
        ("Language", "语言"),
        ("Keep svahost background service", "保持 svahost 后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 svahost 应用设置页面中，找到并进�?[电源] 页面，取消勾�?[不受限制]"),
        ("Start on boot", "开机自启动"),
        ("Start the screen sharing service on boot, requires special permissions", "开机自动启动屏幕共享服务，此功能需要一些特殊权限�?),
        ("Connection not allowed", "对方不允许连�?),
        ("Legacy mode", "传统模式"),
        ("Map mode", "1:1 传输"),
        ("Translate mode", "翻译模式"),
        ...
        ("Are you sure you want to restart", "确定要重�?),
        ...
        ("Prompt", "提示"),
        ("Please wait for confirmation of UAC...", "请等待对方确�?UAC..."),
        ...
        ("Full Access", "完全访问"),
        ("Screen Share", "仅共享屏�?),
        ("ubuntu-21-04-required", "Wayland 需�?Ubuntu 21.04 或更高版本�?),
        ("wayland-requires-higher-linux-version", "Wayland 需要更高版本的 linux 发行版�?请尝�?X11 桌面或更改您的操作系统�?),
        ("xdp-portal-unavailable", ""),
        ("JumpLink", "查看"),
        ("Please Select the screen to be shared(Operate on the peer side).", "请选择要分享的画面（对端操作）�?),
        ("Show svahost", "显示 svahost"),
        ("This PC", "此电�?),
        ("or", "�?),
        ("Elevate", "提权"),
        ("Zoom cursor", "缩放光标"),
        ("Accept sessions via password", "只允许密码访�?),
        ("Accept sessions via click", "只允许点击访�?),
        ("Accept sessions via both", "允许密码或点击访�?),
        ("Please wait for the remote side to accept your session request...", "请等待对方接受你的连�?.."),
        ("One-time Password", "一次性密�?),
        ("Use one-time password", "使用一次性密�?),
        ("One-time password length", "一次性密码长�?),
        ("Request access to your device", "请求访问你的设备"),
        ("Hide connection management window", "隐藏连接管理窗口"),
        ("hide_cm_tip", "在只允许密码连接并且只用固定密码的情况下才允许隐�?),
        ("wayland_experiment_tip", "Wayland 支持处于实验阶段，如果你需要使用无人值守访问，请使用 X11�?),
        ("Right click to select tabs", "右键选择选项�?),
        ("Skipped", "已跳�?),
        ("Add to address book", "添加到地址�?),
        ("Group", "小组"),
        ("Search", "搜索"),
        ("Closed manually by web console", "�?web 控制台手动关�?),
        ("Local keyboard type", "本地键盘类型"),
        ("Select local keyboard type", "请选择本地键盘类型"),
        ("software_render_tip", "如果你使用英伟达显卡, 并且远程窗口在会话建立后会立刻关�? 那么安装 nouveau 驱动并且选择使用软件渲染可能会有帮助。重启软件后生效�?),
        ("Always use software rendering", "始终使用软件渲染"),
        ("config_input", "为了能够通过键盘控制远程桌面, 请给�?svahost \"输入监控\" 权限�?),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给�?svahost \"录音\"权限�?),
        ...
        ("still_click_uac_tip", "依然需要被控端用户在运�?svahost �?UAC 窗口点击确认�?),
        ("Request Elevation", "请求提权"),
        ("wait_accept_uac_tip", "请等待远端用户确�?UAC 对话框�?),
        ...
        ("Codec", "编解�?),
        ("Resolution", "分辨�?),
        ("No transfers in progress", "无进行中的传�?),
        ("Set one-time password length", "设置一次性密码长�?),
        ("RDP Settings", "RDP 设置"),
        ("Sort by", "排序方式"),
        ("New Connection", "新连�?),
        ("Restore", "恢复"),
        ...
        ("Empty Password", "空密�?),
        ("Me", "�?),
        ("identical_file_tip", "此文件与对方的一�?),
        ("show_monitors_tip", "在工具栏上显示监视器"),
        ("View Mode", "浏览模式"),
        ("login_linux_tip", "登录被控端的 Linux 账户，才能启�?X 桌面"),
        ("verify_rustdesk_password_tip", "验证 svahost 密码"),
        ("remember_account_tip", "记住此账�?),
        ("os_account_desk_tip", "在无显示器的环境下，此账户用于登录被控系统，并启用桌�?),
        ("OS Account", "系统账户"),
        ("another_user_login_title_tip", "其他用户已登�?),
        ("another_user_login_text_tip", "断开"),
        ("xorg_not_found_title_tip", "Xorg 未安�?),
        ("xorg_not_found_text_tip", "请安�?Xorg"),
        ("no_desktop_title_tip", "desktop 未安�?),
        ("no_desktop_text_tip", "请安�?desktop"),
        ...
        ("Disable", "禁用"),
        ("Options", "选项"),
        ("resolution_original_tip", "原始分辨�?),
        ("resolution_fit_local_tip", "适应本地分辨�?),
        ("resolution_custom_tip", "自定义分辨率"),
        ("Collapse toolbar", "折叠工具�?),
        ("Accept and Elevate", "接受并提�?),
        ("accept_and_elevate_btn_tooltip", "接受连接并提�?UAC 权限"),
        ("clipboard_wait_response_timeout_tip", "等待拷贝响应超时"),
        ("Incoming connection", "收到的连�?),
        ("Outgoing connection", "发起的连�?),
        ("Exit", "退�?),
        ("Open", "打开"),
        ("logout_tip", "确定要退出登录吗�?),
        ("Service", "服务"),
        ("Start", "启动"),
        ("Stop", "停止"),
        ("exceed_max_devices", "管理的设备数已达到最大�?),
        ("Sync with recent sessions", "同步最近会�?),
        ("Sort tags", "对标签进行排�?),
        ("Open connection in new tab", "在选项卡中打开新连�?),
        ("Move tab to new window", "将标签页移至新窗�?),
        ...
        ("Select", "选择"),
        ("Toggle Tags", "切换标签"),
        ("pull_ab_failed_tip", "获取地址簿失�?),
        ("push_ab_failed_tip", "上传地址簿失�?),
        ...
        ("{} sessions", "{} 个会�?),
        ("scam_title", "你可能被骗了�?),
        ("scam_text1", "如果你正在和素不相识的人通话，而对方要求你使用 svahost 启动服务，请勿继续操作并立刻挂断电话�?),
        ...
        ("Check for software update on startup", "启动时检查软件更�?),
        ("upgrade_rustdesk_server_pro_to_{}_tip", "请升级专业版服务器到{}或更高版本！"),
        ("pull_group_failed_tip", "获取组信息失�?),
        ("Filter by intersection", "按交集过�?),
        ("Remove wallpaper during incoming sessions", "接受会话时移除桌面壁�?),
        ("Test", "测试"),
        ("display_is_plugged_out_msg", "显示器被拔出，切换到第一个显示器�?),
        ("No displays", "没有显示器�?),
        ("Open in new window", "在新的窗口中打开"),
        ("Show displays as individual windows", "在单个窗口中打开显示�?),
        ("Use all my displays for the remote session", "将我的所有显示器用于远程会话"),
        ("selinux_tip", "SELinux 处于启用状态，svahost 可能无法作为被控正常运行�?),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁�?),
        ("Small tiles", "小磁�?),
        ("List", "列表"),
        ...
        ("Plug out all", "拔出所�?),
        ("True color (4:4:4)", "真彩模式�?:4:4�?),
        ("Enable blocking user input", "允许阻止用户输入"),
        ("id_input_tip", "可以输入 ID、直�?IP，或域名和端口号�?域名>:<端口�?）。\n要访问另一台服务器上的设备，请附加服务器地址�?ID>@<服务器地址>?key=<密钥>）。比如，\n9123456234@192.168.16.1:21117?key=5Qbwsde3unUcJBtrx9ZkvUmwFNoExHzpryHuPUdqlWM=。\n要访问公共服务器上的设备，请输入 \"<ID>@public\"，无需密钥。\n\n如果您想要在首次连接时，强制走中继连接，请在 ID 的后面添�?\"/r\"，例如，\"9123456234/r\"�?),
        ("privacy_mode_impl_mag_tip", "模式 1"),
        ("privacy_mode_impl_virtual_display_tip", "模式 2"),
        ("Enter privacy mode", "进入隐私模式"),
        ("Exit privacy mode", "退出隐私模�?),
        ("idd_not_support_under_win10_2004_tip", "不支�?Indirect display driver 。需�?Windows 10 版本 2004 及更高的版本�?),
        ("input_source_1_tip", "输入�?1"),
        ("input_source_2_tip", "输入�?2"),
        ("Swap control-command key", "交换 Control 键和 Command �?),
        ("swap-left-right-mouse", "交换鼠标左右�?),
        ("2FA code", "双重认证代码"),
        ("More", "更多"),
        ("enable-2fa-title", "启用双重认证"),
        ("enable-2fa-desc", "现在请设置身份验证器。您可以在手机或台式电脑上使�?Authy、Microsoft �?Google Authenticator 等验证器。用验证器扫描二维码，然后输入显示的验证码以启用双重认证�?),
        ...
        ("2FA code must be 6 digits.", "双重认证代码必须�?6 位数字�?),
        ("Multiple Windows sessions found", "发现多个 Windows 会话"),
        ("Please select the session you want to connect to", "请选择您要连接的会�?),
        ("powered_by_me", "�?svahost 提供支持"),
        ...
        ("allow-only-conn-window-open-tip", "仅当 svahost 窗口打开时允许连�?),
        ...
        ("default_proxy_tip", "默认代理协议及端口为 Socks5 �?1080"),
        ("no_audio_input_device_tip", "未找到音频输入设�?),
        ("Incoming", "被控"),
        ("Outgoing", "主控"),
        ...
        ("Floating window", "悬浮�?),
        ("floating_window_tip", "有助于保�?svahost 后台服务"),
        ("Keep screen on", "保持屏幕开�?),
        ("Never", "从不"),
        ("During controlled", "被控期间"),
        ("During service is on", "服务开启期�?),
        ...
        ("Volume down", "降低音量"),
        ("Power", "电源"),
        ("Telegram bot", "Telegram 机器�?),
        ("enable-bot-tip", "如果您启用此功能，您可以从您的机器人接收双重认证码，亦可作为连线通知之用�?),
        ("enable-bot-desc", "1. 开启与 @BotFather 的对话。\n2. 发送命�?\"/newbot\"�?您将在完成此步骤后收到权�?(Token)。\n3. 开始与您刚创建的机器人的对话。发送一则以正斜�?(\"/\") 开头的消息来启用它，例�?\"/hello\"�?),
        ("cancel-2fa-confirm-tip", "确定要取消双重认证吗�?),
        ("cancel-bot-confirm-tip", "确定要取�?Telegram 机器人吗�?),
        ("About svahost", "关于 svahost"),
        ("Send clipboard keystrokes", "发送剪贴板按键"),
        ("network_error_tip", "请检查网络连接，然后点击再试"),
        ("Unlock with PIN", "使用 PIN 码解锁设�?),
        ("Requires at least {} characters", "不少于{}个字�?),
        ("Wrong PIN", "PIN 码错�?),
        ("Set PIN", "设置 PIN �?),
        ...
        ("Parent directory", "父目�?),
        ("Resume", "继续"),
        ("Invalid file name", "无效文件�?),
        ("one-way-file-transfer-tip", "被控端启用了单向文件传输"),
        ("Authentication Required", "需要身份验�?),
        ("Authenticate", "认证"),
        ...
        ("Update client clipboard", "更新客户端的剪贴�?),
        ("Untagged", "无标�?),
        ("new-version-of-{}-tip", "{} 版本更新"),
        ("Accessible devices", "可访问的设备"),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "请在远程端将 svahost 客户端升级至版本 {} 或更新版本！"),
        ("d3d_render_tip", "当启�?D3D 渲染时，某些机器可能无法显示远程画面�?),
        ("Use D3D rendering", "使用 D3D 渲染"),
        ("Printer", "打印�?),
        ("printer-os-requirement-tip", "打印机的传出功能需�?Windows 10 或更高版本�?),
        ("printer-requires-installed-{}-client-tip", "请先安装 {} 客户端�?),
        ("printer-{}-not-installed-tip", "未安�?{} 打印机�?),
        ("printer-{}-ready-tip", "{} 打印机已安装，您可以使用打印功能了�?),
        ("Install {} Printer", "安装 {} 打印�?),
        ("Outgoing Print Jobs", "传出的打印任�?),
        ("Incoming Print Jobs", "传入的打印任�?),
        ("Incoming Print Job", "传入的打印任�?),
        ...
        ("View camera", "查看摄像�?),
        ("Enable camera", "允许查看摄像�?),
        ("No cameras", "没有摄像�?),
        ("view_camera_unsupported_tip", "您的远程端不支持查看摄像头�?),
        ("Terminal", "终端"),
        ("Enable terminal", "启用终端"),
        ("New tab", "新建选项�?),
        ("Keep terminal sessions on disconnect", "断开连接时保持终端会�?),
        ...
        ("elevation_username_tip", "输入用户名或域名\\用户�?),
        ("Preparing for installation ...", "准备安装..."),
        ("Show my cursor", "显示我的光标"),
        ("Scale custom", "自定义缩�?),
        ("Custom scale slider", "自定义缩放滑�?),
        ("Decrease", "缩小"),
        ("Increase", "放大"),
        ...
        ("Alias", "别名"),
        ("ScrollEdge", "边缘滚动"),
        ("Allow insecure TLS fallback", "允许回退到不安全�?TLS 连接"),
        ("allow-insecure-tls-fallback-tip", "默认情况下，对于使用 TLS 的协议，svahost 会验证服务器证书。\n启用此选项后，在验证失败时，svahost 将转为跳过验证步骤并继续连接�?),
        ("Disable UDP", "禁用 UDP"),
        ("disable-udp-tip", "控制是否仅使�?TCP。\n启用此选项后，svahost 将不再使�?UDP 21116，而是使用 TCP 21116�?),
        ("server-oss-not-support-tip", "注意：svahost 开源服务器 (OSS server) 不包含此功能�?),
        ("input note here", "输入备注"),
        ("note-at-conn-end-tip", "在连接结束时请求备注"),
        ("Show terminal extra keys", "显示终端扩展�?),
        ("Relative mouse mode", "相对鼠标模式"),
        ("rel-mouse-not-supported-peer-tip", "被控端不支持相对鼠标模式"),
        ("rel-mouse-not-ready-tip", "相对鼠标模式尚未准备好，请稍后再�?),
