...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "狀�?),
        ("Your Desktop", "您的桌面"),
        ("desk_tip", "您可以透過�?ID 及密碼存取您的桌�?),
        ("Password", "密碼"),
        ("Ready", "就緒"),
        ("Established", "已建�?),
        ("connecting_status", "正在連線�?svahost 網路..."),
        ("Enable service", "啟用服務"),
        ("Start service", "啟動服務"),
        ...
        ("Enable keyboard/mouse", "啟用鍵盤和滑�?),
        ("Enable clipboard", "啟用剪貼�?),
        ("Enable file transfer", "啟用檔案傳輸"),
        ("Enable TCP tunneling", "啟用 TCP 通道"),
        ("IP Whitelisting", "IP 白名�?),
        ("ID/Relay Server", "ID / 中繼伺服�?),
        ("Import server config", "匯入伺服器設�?),
        ("Export Server Config", "匯出伺服器設�?),
        ("Import server configuration successfully", "匯入伺服器設定成�?),
        ("Export server configuration successfully", "匯出伺服器設定成�?),
        ("Invalid server configuration", "無效的伺服器設定"),
        ("Clipboard is empty", "剪貼簿是空的"),
        ("Stop service", "停止服務"),
        ("Change ID", "更改 ID"),
        ("Your new ID", "您的�?ID"),
        ("length %min% to %max%", "長度�?%min% �?%max% 之間"),
        ("starts with a letter", "以字母開�?),
        ("allowed characters", "允許的字�?),
        ("id_change_tip", "僅能使用以下字元：a-z、A-Z�?-9�?- (dash)、_ (底線)。第一個字元必須為 a-z �?A-Z。長度介�?6 �?16 之間�?),
        ("Website", "網站"),
        ("About", "關於"),
        ("Slogan_tip", "在這個混沌的世界中用心製作！"),
        ("Privacy Statement", "隱私權宣�?),
        ("Mute", "靜音"),
        ("Build Date", "建構日期"),
        ("Version", "版本"),
        ("Home", "首頁"),
        ...
        ("Relay Server", "中繼伺服�?),
        ("API Server", "API 伺服�?),
        ("invalid_http", "開頭必須�?http:// �?https://"),
        ("Invalid IP", "IP 無效"),
        ("Invalid format", "格式無效"),
        ("server_not_support", "伺服器尚未支�?),
        ("Not available", "無法使用"),
        ...
        ("Retry", "重試"),
        ("OK", "確定"),
        ("Password Required", "需要密�?),
        ("Please enter your password", "請輸入您的密�?),
        ...
        ("Please try 1 minute later", "請於 1 分鐘後再�?),
        ("Login Error", "登入錯誤"),
        ("Successful", "成功"),
        ("Connected, waiting for image...", "已連線，等待畫面傳�?.."),
        ("Name", "名稱"),
        ("Type", "類型"),
        ("Modified", "修改時間"),
        ("Size", "大小"),
        ...
        ("Not an empty directory", "不是一個空資料�?),
        ...
        ("Do this for all conflicts", "套用到其他衝�?),
        ...
        ("Privacy mode", "隱私模式"),
        ("Block user input", "封鎖使用者輸�?),
        ("Unblock user input", "取消封鎖使用者輸�?),
        ("Adjust Window", "調整視窗"),
        ("Original", "原始"),
        ("Shrink", "縮減"),
        ("Stretch", "延展"),
        ...
        ("Disable clipboard", "停用剪貼�?),
        ("Lock after session end", "工作階段結束後鎖定電�?),
        ("Insert Ctrl + Alt + Del", "插入 Ctrl + Alt + Del"),
        ("Insert Lock", "鎖定遠端電腦"),
        ("Refresh", "重新載入"),
        ("ID does not exist", "ID 不存�?),
        ("Failed to connect to rendezvous server", "無法連線�?ID 伺服�?),
        ("Please try later", "請稍候再�?),
        ("Remote desktop is offline", "遠端桌面已離�?),
        ("Key mismatch", "金鑰不符"),
        ("Timeout", "逾時"),
        ...
        ("Failed to make direct connection to remote desktop", "無法直接連線到遠端桌�?),
        ("Set Password", "設定密碼"),
        ("OS Password", "作業系統密碼"),
        ("install_tip", "UAC 會導�?svahost 在某些情況下無法正常作為遠端端點運作。若要避�?UAC，請點選下方按鈕�?svahost 安裝到系統中�?),
        ("Click to upgrade", "點選以升�?),
        ("Configure", "設定"),
        ("config_acc", "為了遠端控制您的桌面，您需要授�?svahost「無障礙功能」權限�?),
        ("config_screen", "為了遠端存取您的桌面，您需要授�?svahost「螢幕錄製」權限�?),
        ("Installing ...", "正在安裝..."),
        ("Install", "安裝"),
        ("Installation", "安裝"),
        ("Installation Path", "安裝路徑"),
        ("Create start menu shortcuts", "新增開始功能表捷�?),
        ("Create desktop icon", "新增桌面捷徑"),
        ("agreement_tip", "開始安裝即表示您接受授權條款�?),
        ("Accept and Install", "接受並安�?),
        ("End-user license agreement", "終端使用者授權合�?),
        ("Generating ...", "正在產生..."),
        ("Your installation is lower version.", "您安裝的版本過舊�?),
        ("not_close_tcp_tip", "在使用通道時請不要關閉此視�?),
        ("Listening ...", "正在等待通道連線..."),
        ("Remote Host", "遠端主機"),
        ("Remote Port", "遠端連接�?),
        ("Action", "操作"),
        ...
        ("Local Port", "本機連接�?),
        ("Local Address", "本機位址"),
        ("Change Local Port", "修改本機連接�?),
        ("setup_server_tip", "若您需要更快的連線速度，您可以選擇自行建立伺服�?),
        ("Too short, at least 6 characters.", "過短，至少需�?6 個字元�?),
        ("The confirmation is not identical.", "兩次輸入不相�?),
        ("Permissions", "權限"),
        ("Accept", "接受"),
        ("Dismiss", "關閉"),
        ("Disconnect", "中斷連線"),
        ("Enable file copy and paste", "允許檔案複製和貼�?),
        ("Connected", "已連線"),
        ...
        ("Fix it", "修復"),
        ("Warning", "警告"),
        ("Login screen using Wayland is not supported", "不支援使�?Wayland 的登入畫�?),
        ("Reboot required", "需要重新啟�?),
        ("Unsupported display server", "不支援的顯示伺服�?),
        ("x11 expected", "預期�?x11"),
        ("Port", "連接�?),
        ("Settings", "設定"),
        ("Username", "使用者名�?),
        ("Invalid port", "連接埠無�?),
        ("Closed manually by the peer", "對方關閉了工作階�?),
        ("Enable remote configuration modification", "允許遠端使用者更改設�?),
        ("Run without install", "跳過安裝直接執行"),
        ("Connect via relay", "中繼連線"),
        ("Always connect via relay", "一律透過中繼連線"),
        ("whitelist_tip", "只有白名單上�?IP 可以存取"),
        ("Login", "登入"),
        ("Verify", "驗證"),
        ("Remember me", "記住�?),
        ("Trust this device", "信任這部裝置"),
        ("Verification code", "驗證�?),
        ("verification_tip", "驗證碼已傳送到註冊的電子郵件地址，請輸入驗證碼以繼續登入�?),
        ("Logout", "登出"),
        ("Tags", "標籤"),
        ("Search ID", "搜尋 ID"),
        ("whitelist_sep", "使用逗號、分號、空格，或是換行來分�?),
        ("Add ID", "新增 ID"),
        ("Add Tag", "新增標籤"),
        ("Unselect all tags", "取消選取所有標�?),
        ("Network error", "網路錯誤"),
        ("Username missed", "缺少使用者名�?),
        ("Password missed", "缺少密碼"),
        ("Wrong credentials", "登入資訊錯誤"),
        ("The verification code is incorrect or has expired", "驗證碼錯誤或已過�?),
        ("Edit Tag", "編輯標籤"),
        ("Forget Password", "忘記密碼"),
        ("Favorites", "我的最�?),
        ("Add to Favorites", "加入我的最�?),
        ("Remove from Favorites", "從我的最愛中移除"),
        ("Empty", "空空如也"),
        ("Invalid folder name", "資料夾名稱無�?),
        ("Socks5 Proxy", "Socks5 代理伺服�?),
        ("Socks5/Http(s) Proxy", "Socks5/Http(s) 代理伺服�?),
        ("Discovered", "已探�?),
        ...
        ("android_input_permission_tip1", "為了讓遠端裝置能夠透過滑鼠或觸控控制您�?Android 裝置，您需要允�?svahost 使用「輔助功能」服務�?),
        ("android_input_permission_tip2", "請前往下一個系統設定頁面，找到並進入「已安裝的服務」，開啟「svahost Input」服務�?),
        ...
        ("android_version_audio_tip", "目前�?Android 版本不支援音訊錄製，請升級至 Android 10 或更新的版本�?),
        ("android_start_service_tip", "點選「啟動服務」或啟用「畫面錄製」權限以啟動螢幕分享服務�?),
        ("android_permission_may_not_change_tip", "已建立連線的權限可能不會立即改變，除非重新連線�?),
        ("Account", "帳號"),
        ("Overwrite", "取代"),
        ("This file exists, skip or overwrite this file?", "此檔�?資料夾已存在，要略過或是取代此檔案嗎�?),
        ("Quit", "退�?),
        ("Help", "說明"),
        ("Failed", "失敗"),
        ("Succeeded", "成功"),
        ("Someone turns on privacy mode, exit", "有人開啟了隱私模式，退�?),
        ("Unsupported", "不支�?),
        ("Peer denied", "對方拒絕"),
        ("Please install plugins", "請安裝外掛程�?),
        ("Peer exit", "對方退�?),
        ("Failed to turn off", "關閉失敗"),
        ("Turned off", "已關�?),
        ("Language", "語言"),
        ("Keep svahost background service", "保持 svahost 後台服務"),
        ("Ignore Battery Optimizations", "忽略電池最佳化"),
        ("android_open_battery_optimizations_tip", "如果您想要停用此功能，請前往下一�?svahost 應用程式設定頁面，找到並進入「電池」，取消勾選「不受限制�?),
        ("Start on boot", "開機時啟�?),
        ...
        ("Network", "網路"),
        ("Pin Toolbar", "釘選工具�?),
        ("Unpin Toolbar", "取消釘選工具�?),
        ("Recording", "錄製"),
        ("Directory", "路徑"),
        ("Automatically record incoming sessions", "自動錄製連入的工作階�?),
        ("Automatically record outgoing sessions", "自動錄製連出的工作階�?),
        ("Change", "變更"),
        ("Start session recording", "開始錄影"),
        ("Stop session recording", "停止錄影"),
        ("Enable recording session", "啟用錄製工作階段"),
        ("Enable LAN discovery", "允許區域網路探�?),
        ("Deny LAN discovery", "拒絕區域網路探�?),
        ("Write a message", "輸入聊天訊息"),
        ("Prompt", "提示"),
        ("Please wait for confirmation of UAC...", "請等待對方確�?UAC..."),
        ("elevated_foreground_window_tip", "目前遠端桌面的視窗需要更高的權限才能繼續操作，您暫時無法使用滑鼠和鍵盤，您可以請求對方最小化目前視窗，或者在連線管理視窗點選提升權限。為了避免這個問題，建議在遠端裝置上安裝本軟體�?),
        ("Disconnected", "斷開連線"),
        ("Other", "其他"),
        ("Confirm before closing multiple tabs", "關閉多個分頁前詢問�?),
        ("Keyboard Settings", "鍵盤設定"),
        ("Full Access", "完全存取"),
        ("Screen Share", "僅分享螢幕畫�?),
        ("ubuntu-21-04-required", "Wayland 需�?Ubuntu 21.04 或更新的版本�?),
        ("wayland-requires-higher-linux-version", "Wayland 需要更新版�?Linux 發行版。請嘗試使用 X11 桌面或更改您的作業系統�?),
        ("xdp-portal-unavailable", ""),
        ("JumpLink", "查看"),
        ("Please Select the screen to be shared(Operate on the peer side).", "請選擇要分享的螢幕畫面（在對方的裝置上操作）�?),
        ("Show svahost", "顯示 svahost"),
        ("This PC", "此電�?),
        ("or", "�?),
        ("Elevate", "提升權限"),
        ("Zoom cursor", "縮放游標"),
        ...
        ("One-time Password", "一次性密�?),
        ("Use one-time password", "使用一次性密�?),
        ("One-time password length", "一次性密碼長�?),
        ...
        ("Skipped", "已跳�?),
        ("Add to address book", "新增到通訊�?),
        ("Group", "群組"),
        ("Search", "搜尋"),
        ("Closed manually by web console", "�?Web 控制台手動關�?),
        ("Local keyboard type", "本機鍵盤類型"),
        ("Select local keyboard type", "請選擇本機鍵盤類�?),
        ("software_render_tip", "如果您使�?Nvidia 顯示卡，並且遠端視窗在建立連線後會立刻關閉，那麼請安裝 nouveau 顯示卡驅動程式並且選擇使用軟體繪製可能會有幫助。重新啟動軟體後生效�?),
        ("Always use software rendering", "使用軟體繪製"),
        ("config_input", "為了能夠透過鍵盤控制遠端桌面，請給予 svahost「輸入監控」權限�?),
        ("config_microphone", "為了支援透過麥克風進行音訊傳輸，請給予 svahost「錄音」權限�?),
        ("request_elevation_tip", "如果遠端使用者可以操作電腦，您可以請求提升權限�?),
        ("Wait", "等待"),
        ("Elevation Error", "權限提升失敗"),
        ("Ask the remote user for authentication", "請求遠端使用者進行驗證"),
        ("Choose this if the remote account is administrator", "當遠端使用者帳戶是管理員時，請選擇此選�?),
        ("Transmit the username and password of administrator", "傳送管理員的使用者名稱和密碼"),
        ("still_click_uac_tip", "依然需要遠端使用者在執行 svahost 時於 UAC 視窗點選「是」�?),
        ("Request Elevation", "請求權限提升"),
        ("wait_accept_uac_tip", "請等待遠端使用者確�?UAC 對話框�?),
        ...
        ("relay_hint_tip", "可能無法使用直接連線，您可以嘗試中繼連線。\n另外，如果想要直接使用中繼連線，您可以�?ID 後面新增�?r」，或是如果近期的工作階段裡存在該裝置，您也可以在裝置選項裡選擇「一律透過中繼連線」�?),
        ("Reconnect", "重新連線"),
        ("Codec", "編解碼器"),
        ("Resolution", "解析�?),
        ("No transfers in progress", "沒有正在進行的傳�?),
        ...
        ("Empty Username", "空使用者帳�?),
        ("Empty Password", "空密�?),
        ("Me", "�?),
        ("identical_file_tip", "此檔案與對方的檔案一致�?),
        ("show_monitors_tip", "在工具列中顯示顯示器"),
        ("View Mode", "瀏覽模式"),
        ("login_linux_tip", "需要登入到遠端 Linux 使用者帳戶才能啟�?X 桌面環境"),
        ("verify_rustdesk_password_tip", "驗證 svahost 密碼"),
        ("remember_account_tip", "記住此使用者帳�?),
        ("os_account_desk_tip", "此使用者帳戶將用於登入遠端作業系統並啟用無頭模�?(headless mode) 的桌面連線"),
        ("OS Account", "作業系統使用者帳�?),
        ("another_user_login_title_tip", "另一個使用者已經登�?),
        ("another_user_login_text_tip", "斷開連線"),
        ("xorg_not_found_title_tip", "找不�?Xorg"),
        ("xorg_not_found_text_tip", "請安�?Xorg"),
        ("no_desktop_title_tip", "沒有可用的桌面環�?),
        ("no_desktop_text_tip", "請安�?GNOME 桌面"),
        ("No need to elevate", "不需要提升權�?),
        ("System Sound", "系統音效"),
        ("Default", "預設"),
        ("New RDP", "新的 RDP"),
        ("Fingerprint", "指紋"),
        ...
        ("Disable", "停用"),
        ("Options", "選項"),
        ("resolution_original_tip", "原始解析�?),
        ("resolution_fit_local_tip", "調整成本機解析度"),
        ("resolution_custom_tip", "自訂解析�?),
        ("Collapse toolbar", "收回工具�?),
        ("Accept and Elevate", "接受並提升權�?),
        ("accept_and_elevate_btn_tooltip", "接受連線並提�?UAC 權限�?),
        ...
        ("Sync with recent sessions", "與近期工作階段同�?),
        ("Sort tags", "排序標籤"),
        ...
        ("Select", "選擇"),
        ("Toggle Tags", "切換標籤"),
        ("pull_ab_failed_tip", "通訊錄更新失�?),
        ("push_ab_failed_tip", "同步通訊錄至伺服器失�?),
        ...
        ("Plug out all", "拔出所�?),
        ("True color (4:4:4)", "全彩模式�?:4:4�?),
        ("Enable blocking user input", "允許封鎖使用者輸�?),
        ("id_input_tip", "您可以輸�?ID、IP、或網域名稱+連接埠（<網域名稱>:<連接�?）。\n如果您要存取位於其他伺服器上的裝置，請在 ID 之後新增伺服器位址�?ID>@<伺服器位址>?key=<金鑰>）\n例如�?123456234@192.168.16.1:21117?key=5Qbwsde3unUcJBtrx9ZkvUmwFNoExHzpryHuPUdqlWM=\n要存取公共伺服器上的裝置，請輸入�?id>@public」，不需輸入金鑰。\n\n如果您想要在第一次連線時，強制使用中繼連線，請�?ID 的結尾新增�?r」，例如，�?123456234/r」�?),
        ("privacy_mode_impl_mag_tip", "模式 1"),
        ("privacy_mode_impl_virtual_display_tip", "模式 2"),
        ("Enter privacy mode", "進入隱私模式"),
        ("Exit privacy mode", "退出隱私模�?),
        ("idd_not_support_under_win10_2004_tip", "不支�?Indirect display driver。需�?Windows 10 版本 2004 以上版本�?),
        ("input_source_1_tip", "輸入�?1"),
        ("input_source_2_tip", "輸入�?2"),
        ("Swap control-command key", "交換 Control �?Command 按鍵"),
        ("swap-left-right-mouse", "交換滑鼠左右�?),
        ("2FA code", "二步驟驗證碼"),
        ("More", "更多"),
        ("enable-2fa-title", "啟用二步驟驗�?),
        ("enable-2fa-desc", "現在請您設定您的二步驟驗證程式。您可以在手機或電腦使用 Authy、Microsoft �?Google Authenticator 等驗證器程式。\n\n用它掃描QR Code或輸入下方金鑰至您的驗證器，然後輸入顯示的驗證碼以啟用二步驟驗證�?),
        ("wrong-2fa-code", "無法驗證此驗證碼。請確認您的驗證碼和您的本機時間設定是正確的"),
        ("enter-2fa-title", "二步驟驗�?),
        ("Email verification code must be 6 characters.", "電子郵件驗證碼必須是 6 個字元�?),
        ("2FA code must be 6 digits.", "二步驟驗證碼必須�?6 位數字�?),
        ("Multiple Windows sessions found", "發現多�?Windows 工作階段"),
        ("Please select the session you want to connect to", "請選擇您想要連結的工作階�?),
        ("powered_by_me", "�?svahost 提供支援"),
        ...
        ("allow-only-conn-window-open-tip", "只在 svahost 視窗開啟時允許連接"),
        ...
        ("default_proxy_tip", "預設代理協定及通訊埠為 Socks5 �?1080"),
        ("no_audio_input_device_tip", "未找到音訊輸入裝�?),
        ("Incoming", "連入"),
        ("Outgoing", "連出"),
        ("Clear Wayland screen selection", "清除 Wayland 的螢幕選�?),
        ...
        ("floating_window_tip", "有助於保�?svahost 後台服務"),
        ...
        ("Volume down", "降低音量"),
        ("Power", "電源"),
        ("Telegram bot", "Telegram 機器�?),
        ("enable-bot-tip", "如果您啟用此功能，您可以從您的機器人接收二步驟驗證碼，亦可作為連線通知之用�?),
        ("enable-bot-desc", "1. 開啟�?@BotFather 的對話。\n2. 傳送指令�?newbot」。您將會在完成此步驟後收到權�?(Token)。\n3. 開始與您剛創立的機器人的對話。傳送一則以正斜�?(�?�? 開頭的訊息來啟用它，例如�?hello」�?),
        ("cancel-2fa-confirm-tip", "確定要取消二步驟驗證嗎？"),
        ("cancel-bot-confirm-tip", "確定要取�?Telegram 機器人嗎�?),
        ("About svahost", "關於 svahost"),
        ("Send clipboard keystrokes", "傳送剪貼簿按鍵"),
        ("network_error_tip", "請檢查網路連結，然後點選重�?),
        ("Unlock with PIN", "使用 PIN 碼解鎖設�?),
        ("Requires at least {} characters", "不少�?{} 個字�?),
        ("Wrong PIN", "PIN 碼錯�?),
        ("Set PIN", "設定 PIN �?),
        ...
        ("Update client clipboard", "更新客戶端的剪貼�?),
        ("Untagged", "無標�?),
        ("new-version-of-{}-tip", "有新版本�?{} 可用"),
        ("Accessible devices", "可存取的裝置"),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "請將遠端 svahost 客戶端升級到 {} 或更新版本！"),
        ("d3d_render_tip", "當啟�?D3D 渲染時，某些機器可能會無法顯示遠端畫面�?),
        ("Use D3D rendering", "使用 D3D 渲染"),
        ("Printer", "印表�?),
        ("printer-os-requirement-tip", "印表機的傳出功能需�?Windows 10 或更高版本�?),
        ...
        ("Install {} Printer", "安裝 {} 印表�?),
        ("Outgoing Print Jobs", "傳出的列印任�?),
        ("Incoming Print Jobs", "傳入的列印任�?),
        ("Incoming Print Job", "傳入的列印任�?),
        ...
        ("Failed to get user token.", "取得使用者權杖失�?),
        ("Incorrect username or password.", "使用者名稱或密碼不正�?),
        ("The user is not an administrator.", "使用者並不是系統管理�?),
        ("Failed to check if the user is an administrator.", "檢查使用者是否是系統管理員時失敗�?),
        ("Supported only in the installed version.", "僅支援於已安裝的版本"),
        ("elevation_username_tip", "輸入使用者名稱或網域\\使用者名�?),
        ...
        ("Alias", "別名"),
        ("ScrollEdge", "邊緣滾動"),
        ("Allow insecure TLS fallback", "允許降級到不安全�?TLS 連接"),
        ("allow-insecure-tls-fallback-tip", "預設情況下，對於使用 TLS 的協定，svahost 會驗證伺服器的憑證。\n啟用此選項後，在驗證失敗時，svahost 將轉為跳過驗證步驟並繼續連接�?),
        ("Disable UDP", "停用 UDP"),
        ("disable-udp-tip", "控制是否僅使�?TCP。\n啟用此選項後，svahost 將不再使�?UDP 21116，而是使用 TCP 21116�?),
        ("server-oss-not-support-tip", "注意：svahost 開源伺服�?(OSS server) 不包含此功能�?),
        ("input note here", "輸入備註"),
        ("note-at-conn-end-tip", "在連接結束時請求備�?),
        ("Show terminal extra keys", "顯示終端機額外按�?),
        ("Relative mouse mode", "相對滑鼠模式"),
        ("rel-mouse-not-supported-peer-tip", "被控端不支援相對滑鼠模式"),
        ("rel-mouse-not-ready-tip", "相對滑鼠模式尚未就緒，請稍候再�?),
        ("rel-mouse-lock-failed-tip", "無法鎖定游標，相對滑鼠模式已停用"),
        ("rel-mouse-exit-{}-tip", "按下 {} 退�?),
