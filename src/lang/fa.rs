...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "لطفا برنامه را نصب کنید UAC و جلوگیری از خطای Svahost برای راحتی در استفاده از نرم افزار"),
        ("Click to upgrade", "برای ارتقا کلیک کنید"),
        ("Configure", "تنظیم"),
        ("config_acc", "بدهید \"access\" مجوز Svahost برای کنترل از راه دور دسکتاپ باید به"),
        ("config_screen", "بدهید \"screenshot\" مجوز Svahost برای کنترل از راه دور دسکتاپ باید به"),
        ...
        ("android_input_permission_tip1", "استفاده کند \"Accessibility\" اجازه دهید از ویژگی Svahost شما را از طریق ماوس یا صفحه ی لمسی کنترل کند، باید به Android برای اینکه یک دستگاه از راه دور بتواند دستگاه"),
        ("android_input_permission_tip2", "را پیدا کنید و فعال نمایید \"Svahost Input\" بشوید ، سپس گزینه \"Installed Services\" وارد قسمت \"Accessibility\" در صفحه تنظیمات "),
        ...
        ("android_version_audio_tip", "نسخه فعلی اندروید از ضبط صدا پشتیبانی نمی‌کند�?لطفاً به اندروید 10 یا بالاتر به‌روزرسان�?کنید"),
        ("android_start_service_tip", "را فعال کنید [Screen Capture] ضربه بزنید یا مجوز [Start service] برای شروع سرویس اشتراک ‌گذار�?صفحه، روی"),
        ...
        ("Turned off", "خاموش شد"),
        ("Language", "زبان"),
        ("Keep Svahost background service", "را در پس زمینه نگه دارید Svahost سرویس"),
        ...
        ("Start the screen sharing service on boot, requires special permissions", "سرویس اشتراک‌گذار�?صفحه را در بوت راه‌انداز�?کنید، به مجوزهای خاصی نیاز دارد"),
        ...
        ("JumpLink", "چشم انداز"),
        ("Please Select the screen to be shared(Operate on the peer side).", "لطفاً صفحه‌ا�?را برای اشتراک‌گذار�?انتخاب کنید (در سمت همتا به همتا کار کنید)."),
        ("Show Svahost", "Svahost نمایش"),
        ("This PC", "This PC"),
        ("or", "یا"),
        ("Elevate", "ارتقاء"),
        ...
        ("config_input", "برای کنترل دسکتاپ از راه دور با صفحه کلید، باید مجوز Svahost \"Input Monitoring\" را بدهید."),
        ("config_microphone", "را بدهید. Svahost \"Record Audio\" برای صحبت از راه دور، باید مجوز"),
        ...
        ("still_click_uac_tip", "همچنان کاربر از راه دور نیاز دارد که روی OK در پنجره UAC اجرای Svahost کلیک کند."),
        ...
        ("relay_hint_tip", " را به شناسه اضافه کنید یا گزینه \" همیشه از طریق رله متصل شوید\" را در کارت همتا انتخاب کنید. همچنین، اگر می‌خواهی�?فوراً از سرور رله استفاده کنید، می‌توانی�?پسوند \"/r\".\n اتصال مستقیم ممکن است امکان پذیر نباشد. در این صورت می توانید سعی کنید از طریق سرور رله متصل شوید"),
        ...
        ("verify_rustdesk_password_tip", "رمز عبور Svahost را تأیید کنید"),
        ...
        ("scam_text1", "استفاده کنید و سرویس را راه‌انداز�?کنید، صحبت می‌کنید�?ادامه ندهید و بلافاصله تلفن را قطع کنید Svahost اگر با شخصی که نمی‌شناسی�?و به او اعتماد ندارید و از شما خواسته است از"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "را به نسخه {} یا جدیدتر ارتقا دهید Svahost Server Pro لظفا"),
        ...
        ("selinux_tip", "به عنوان کنترل شده جلوگیری کند Svahost روی دستگاه شما فعال است ، که ممکن است از اجرای صحیح SELinux"),
        ...
        ("Swap control-command key", "گرفتن چندین نمایشگر در حالت کاربر زیاد پشتیبانی نمی شود. اگر می‌خواهی�?چند نمایشگر را کنترل کنید، لطفاً پس از نصب دوباره امتحان کنید."),
        ...
        ("allow-only-conn-window-open-tip", "باز است اتصال برقرار شود Svahost زمانی که"),
        ...
        ("floating_window_tip", "کمک می کند Svahost این به حفظ سرویس پس زمینه"),
        ...
        ("enable-bot-desc", "ربات، اعلان‌ها�?اتصال و کدهای تأیید دو مرحله‌ا�?را برای شما ارسال می‌کن�?"),
        ...
        ("Enable trusted devices", "فعال کردن دستگاه‌ها�?مورد اعتماد"),
        ("Manage trusted devices", "مدیریت دستگاه‌ها�?مورد اعتماد"),
        ("Platform", "پلتفرم"),
        ("Days remaining", "روزهای باقی‌ماند�?),
        ("enable-trusted-devices-tip", "فعال کردن این گزینه فقط به دستگاه‌ها�?مورد اعتماد اجازه اتصال می‌ده�?),
        ("Parent directory", "فهرست والد"),
        ("Resume", "ادامه دادن"),
        ("Invalid file name", "نام فایل نامعتبر است"),
        ("one-way-file-transfer-tip", "انتقال فایل فقط در یک جهت انجام می‌شو�?),
        ...
        ("Upload files", "آپلود فایل‌ه�?),
        ("Clipboard is synchronized", "کلیپ‌بور�?همگام‌ساز�?شده است"),
        ("Update client clipboard", "به‌روزرسان�?کلیپ‌بور�?کاربر"),
        ("Untagged", "بدون برچسب"),
        ("new-version-of-{}-tip", "نسخه جدید {} در دسترس است"),
        ("Accessible devices", "دستگاه‌ها�?در دسترس"),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "لطفاً Svahost را به نسخه {} یا جدیدتر در سمت راه دور ارتقا دهید"),
        ("d3d_render_tip", "فعال کردن رندر D3D برای عملکرد بهتر"),
        ("Use D3D rendering", "استفاده از رندر D3D"),
        ("Printer", "چاپگر"),
        ("printer-os-requirement-tip", "سیستم‌عام�?شما باید از چاپ از راه دور پشتیبانی کند"),
        ...
        ("use-the-default-printer-tip", "از چاپگر پیش‌فر�?استفاده کنید"),
        ("use-the-selected-printer-tip", "از چاپگر انتخاب‌شد�?استفاده کنید"),
        ("auto-print-tip", "چاپ خودکار فعال است"),
        ("print-incoming-job-confirm-tip", "آیا می‌خواهی�?کار چاپ ورودی را تأیید کنید"),
        ...
        ("Trackpad speed", "سرعت ترک‌پ�?),
        ("Default trackpad speed", "سرعت پیش‌فر�?ترک‌پ�?),
        ("Numeric one-time password", "رمز عبور یک‌با�?مصرف عددی"),
        ("Enable IPv6 P2P connection", "فعال‌ساز�?اتصال همتا‌به‌همتا�?IPv6"),
        ("Enable UDP hole punching", "فعال‌ساز�?تکنیک UDP hole punching"),
        ...
        ("Terminal", "ترمینال"),
        ("Enable terminal", "فعال‌ساز�?ترمینال"),
        ("New tab", "زبانه جدید"),
        ...
        ("Supported only in the installed version.", "فقط در نسخه نصب�?شده پشتیبانی می‌شو�?"),
        ("elevation_username_tip", "وارد نمایید domain\\username یا username نام کاربری را به صورت"),
        ("Preparing for installation ...", "در حال آماده‌ساز�?برای نصب..."),
        ...
        ("Small", "کوچک"),
        ("Large", "بزرگ"),
        ("Show virtual joystick", "نمایش جوی‌استی�?مجازی"),
        ("Edit note", "ویرایش یادداشت"),
        ("Alias", "نام مستعار"),
        ("ScrollEdge", ""),
        ("Allow insecure TLS fallback", "استفاده از TLS غیر امن در ارتباط"),
        ("allow-insecure-tls-fallback-tip", "به‌طو�?پیش‌فرض�?Svahost گواهی سرور را برای پروتکل‌ه�?با استفاده از TLS تأیید می‌کن�?\nبا فعال بودن این گزینه، Svahost دوباره مرحله تأیید را رد می‌کن�?و در صورت عدم موفقیت تأیید ادامه می‌ده�?"),
        ("Disable UDP", "UDP غیر فعال کردن"),
        ("disable-udp-tip", "کنترل می کند که آیا فقط از TCP استفاده شود یا خیر.\nوقتی این گزینه فعال باشد، Svahost دیگر از UDP 21116 استفاده نمی کند، به جای آن از TCP 21116 استفاده می شود."),
        ("server-oss-not-support-tip", "توجه: سرور Svahost OSS این ویژگی را ندارد."),
